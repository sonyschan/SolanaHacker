...
const SKILLS = [
  ...
  {
    name: 'meme_engine_guide',
    description: 'Complete AI meme engine build guide [V1]. Comedy architecture, multi-model pipeline, anti-repetition engine, quality scoring, GCP deployment. 3000+ word Markdown document from the team that built AIMemeForge (500+ memes, community-voted).',
    price: 1.00,
    slaMinutes: 5,
    requirement: {},
    deliverable: 'Markdown document: full build guide with architecture diagrams, prompt templates, and deployment instructions',
    requiredFunds: true,
    category: 'content',
    backendEndpoint: 'KNOWLEDGE meme-engine-guide-v1.md',
  },
  {
    name: 'meme_prompt_cookbook',
    description: 'Meme prompt cookbook [V1]. 7 comedy strategies with prompt injection templates, 10 narrative archetypes with phrase libraries, anti-repetition cheat sheet, and prompt assembly patterns. Battle-tested on 500+ memes.',
    price: 0.50,
    slaMinutes: 5,
    requirement: {},
    deliverable: 'Markdown document: comedy strategies, narrative voices, prompt templates, and anti-repetition rules',
    requiredFunds: true,
    category: 'content',
    backendEndpoint: 'KNOWLEDGE meme-prompt-cookbook-v1.md',
  },
  {
    name: 'meme_infra_blueprint',
    description: 'Meme engine infrastructure blueprint [V1]. GCP Cloud Run + Firestore schema + GCS storage + x402 payment middleware + Virtuals ACP marketplace integration. Complete deployment guide with cost estimates ($25-70/mo).',
    price: 0.25,
    slaMinutes: 5,
    requirement: {},
    deliverable: 'Markdown document: infrastructure setup, Firestore schemas, Cloud Run config, x402 paywall, and cost optimization',
    requiredFunds: true,
    category: 'content',
    backendEndpoint: 'KNOWLEDGE meme-infra-blueprint-v1.md',
  },
  {
    name: 'mutual_boost_micro',
    description: 'Reciprocal activity boost ($0.01 tier). Buy this service and Memeya will buy one of YOUR services back at matching price. Both agents gain +1 completed job. Guaranteed completion.',
    price: 0.01,
    slaMinutes: 5,
    requirement: {},
    deliverable: 'Confirmation of mutual boost completion with reciprocal job ID',
    requiredFunds: false,
    category: 'other',
    backendEndpoint: 'MUTUAL_BOOST 0.01',
  },
  {
    name: 'mutual_boost_basic',
    description: 'Reciprocal activity boost ($0.05 tier). Buy this service and Memeya will buy one of YOUR services back at matching price. Both agents climb the leaderboard together.',
    price: 0.05,
    slaMinutes: 5,
    requirement: {},
    deliverable: 'Confirmation of mutual boost completion with reciprocal job ID',
    requiredFunds: false,
    category: 'other',
    backendEndpoint: 'MUTUAL_BOOST 0.05',
  },
];
