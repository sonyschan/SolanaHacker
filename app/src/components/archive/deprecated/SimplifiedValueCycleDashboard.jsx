...
import SimplifiedSolanaWalletButton from './SimplifiedSolanaWallet';

const SimplifiedValueCycleDashboard = () => {
  const { connected, publicKey } = useSimplifiedSolanaWallet();
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-4">
            <SimplifiedSolanaWalletButton 
              ...
              showAddress={false}
            >
              {connected ? `${userTickets} 彩票` : '連接錢包'}
            </SimplifiedSolanaWalletButton>
            {connected && (
              <div className="text-center md:text-right">
                <p className="text-purple-300 text-sm">中獎機率</p>
        ...
        <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-2xl p-6 mb-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-yellow-400 mb-2">免費投票，真實 SOL 獎勢！</h2>
          <p className="text-gray-300 max-w-3xl mx-auto">
            每次投票獲得彩票，參與 {prizePool} SOL 獎池分配。你的投票決定 Meme 稀有度，影響 NFT 價值和獎勵分配。
          </p>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`p-2 rounded-full mr-3 text-2xl ${
                        isActive 
...
export default SimplifiedValueCycleDashboard;