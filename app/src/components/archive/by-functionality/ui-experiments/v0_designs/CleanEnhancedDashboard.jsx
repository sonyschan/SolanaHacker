...
const CleanEnhancedDashboard = () => {
  ...
  // Clean wallet connection component integrated into header
  const WalletConnection = () => {
    ...
    if (connecting) {
      return (
        <div className="flex items-center space-x-2 bg-purple-100 rounded-xl px-3 sm:px-4 py-2">
          <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-purple-600"></div>
          <span className="text-purple-800 font-medium text-sm">Connecting...</span>
        </div>
      );
    }
    ...
    if (connected && publicKey) {
      return (
        <div className="flex items-center space-x-2 bg-green-100 border border-green-300 rounded-xl px-3 sm:px-4 py-2">
          ...
          <WalletMultiButton className="!bg-green-600 hover:!bg-green-700 !text-white !text-xs !px-2 !py-1 !rounded-lg !border-0" />
        </div>
      );
    }

    // Not connected - clean purple button
    return (
      <div className="relative">
        <WalletMultiButton className="!bg-gradient-to-r !from-purple-600 !to-blue-600 hover:!from-purple-700 hover:!to-blue-700 !text-white !font-semibold !px-4 sm:!px-6 !py-2 sm:!py-3 !rounded-xl !border-0 !shadow-lg hover:!shadow-xl !transition-all !duration-300 !text-sm sm:!text-base">
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              {/* Single clean wallet connection */}
              <WalletConnection />
            </div>
          </div>
        </div>
      ...
      {/* Clean CTA Banner for Disconnected Users - No orange, consistent purple */}
      {!connected && (
          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-sm sm:text-base">Connect wallet to vote on AI memes and win SOL prizes!</span>
              </div>
              <button 
                onClick={scrollToVoting}
                className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg font-medium transition-colors backdrop-blur text-sm"
              >
                Learn How →
              </button>
            </div>
      ...
      {/* Clean Sidebar Content as Full Width Sections */}
      <section className="py-8 sm:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            
            {/* Next Draw */}
            <div className="bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl sm:rounded-3xl p-4 sm:p-6 text-white shadow-xl">
              ...
              <div className="text-center">
                ...
                <div className="text-purple-100 text-xs sm:text-sm">UTC • Live streamed</div>
                <div className="text-xl sm:text-2xl font-bold mt-4"><SOLTooltip>12.7 SOL</SOLTooltip></div>
                <div className="text-purple-100 text-xs sm:text-sm">Prize Pool ($2,540)</div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-lg border border-gray-100">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-2 sm:p-3 bg-purple-50 rounded-xl sm:rounded-2xl">
...
export default CleanEnhancedDashboard;