    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center mb-20 md:mb-28">
          ...
          {/* Memeya OS Version Badge */}
          <button
            onClick={() => setShowChangelog(true)}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/25 hover:border-emerald-500/50 hover:bg-emerald-500/15 transition-all mb-8 group cursor-pointer"
          >
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-xs font-mono text-emerald-400 font-bold tracking-wider">Memeya OS v1.1</span>
            <span className="text-[10px] text-gray-500 group-hover:text-gray-400 transition-colors">changelog</span>
          </button>
      ...
      {showChangelog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setShowChangelog(false)}>
          ...
          <div
            className="relative bg-[#0D1117] border border-emerald-500/30 rounded-2xl max-w-lg w-full max-h-[80vh] overflow-y-auto shadow-2xl shadow-emerald-500/10"
          ...
          >
            ...
            <div className="sticky top-0 bg-[#0D1117] border-b border-white/10 px-6 py-4 flex items-center justify-between">
              ...
              <button onClick={() => setShowChangelog(false)} className="text-gray-500 hover:text-white text-xl leading-none">&times;</button>
            </div>
