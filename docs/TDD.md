...
│   ├── chat-mode.js           # Heartbeat: maybePostToX + maybeCommunityEngage + maybeDistillMemory
...
| `agent/chat-mode.js` | Heartbeat → maybePostToX (2-4hr) + maybeCommunityEngage (2-4hr) + maybeDistillMemory (biweekly) |
