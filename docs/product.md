...
### AI 梗圖生成
→ *TDD §4: Meme Generation Pipeline*

每日 00:00 UTC 自動生成 3 張「歷史性 AI 梗圖 (Historical AI Memes)」— 目標是捕捉影響加密圈與世界的最重要時刻。48 小時內新聞，Gemini/Grok 隨機生成圖像。每張標記生成模型。
...
**Anti-repetition**: 過去 7 天梗圖主題自動避免重複選題。
